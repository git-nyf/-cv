...
- 源数据集: `D:\AAA中药cv\yolo12_tcm_project\data\classification_strict_jpeg`
- 输出数据集: `D:\AAA中药cv\yolo12_tcm_project\data\classification_strict_jpeg_leakage_clean_candidate`
...
- 移除图片: 34 / 请求移除 34
- 类别数: 92
- 源划分: {'train': 7826, 'val': 1741}
- 输出划分: {'train': 7826, 'val': 1707}
- 移除划分: {'val': 34}
